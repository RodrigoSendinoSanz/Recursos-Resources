...
public class Main {
	...
	public static void main(String[] args) {
		...
		lable.setFont(new Font("MV Boli",Font.BOLD,30));//tipo de tipografia y tamaño
		...
		lable.setHorizontalAlignment(JLabel.CENTER);// eje horizontal del texto + la imagen
					 //  x/y dimensiones
		//lable.setBounds(0,0,250,250);//posicion y tamaño
		...
		frame.pack();// se ajusta a el tamaño que haya dentro
